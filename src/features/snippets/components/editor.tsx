 ...
 * @description Monaco-based code editor component with snippet management and publishing capabilities
 */
...
export function Editor() {
	const { snippets, selectedSnippetId, updateSnippet, publishSnippet } =
		useSnippetStore()
		...
		<div className="h-full flex flex-col">
			...
			<div className="flex-1 bg-[#1E1E1E]">
				<MonacoEditor
					...
					onChange={(value) =>
						updateSnippet(selectedSnippet.id, { code: value || '' })
					}
					theme="vs-dark"
					options={{
