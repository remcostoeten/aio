...
const LEFT_FILL = 'var(--white))'
const RIGHT_FILL = 'var(--white)'
const EASING = [0.97, 0.67, 0.83, 1.27] // Same as JUMP bezier curve
...
export default function BrandLogo({
	...
	return link ? (
		<a href={typeof link === 'string' ? link : '/'}>{svgElement}</a>
	) : (
		svgElement
	)
}
